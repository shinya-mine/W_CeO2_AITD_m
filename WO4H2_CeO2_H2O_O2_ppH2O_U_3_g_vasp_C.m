...
name_head = 'WO4H2_CeO2_H2O_O2_ppH2O_g_vasp';
...
% WxOyHz/CeO2
energy =[
    -1286.178156 % W1O4H2 (x=1, y=4, z=2)
    -1270.805687 % W1O3H0 (x=1, y=3, z=0)
    -1301.554684 % W1O5H4 (x=1, y=5, z=4)
    -1321.610387 % W2O7H2 (x=2, y=7, z=2)
    -1336.614915 % W2O8H4 (x=2, y=8, z=4)
    -1352.124999 % W2O9H6 (x=2, y=9, z=6)
    -1356.721431 % W3O10H2 (x=3, y=10, z=2)
    -1372.553271 % W3O11H4 (x=3, y=11, z=4)
    -1388.381099 % W3O12H6 (x=3, y=12, z=6)
    -1392.017115 % W4O13H2 (x=4, y=13, z=2)
    -1407.397745 % W4O14H4 (x=4, y=14, z=4)
    -1422.790555 % W4O15H6 (x=4, y=15, z=6)
    -1437.437869 % W4O16H8 (x=4, y=16, z=8)
    -1451.620509 % W4O17H10 (x=4, y=17, z=10)
    ];
